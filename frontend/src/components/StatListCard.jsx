...
export default function StatListCard({
  ...
  return (
    ...
    >
      <h2 className="font-display text-xl sm:text-2xl font-semibold text-fg mb-4">{title}</h2>
          ...
          {items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-center justify-between gap-2 sm:gap-3 rounded-xl px-2 sm:px-3 py-2.5 sm:py-3 hover:bg-fg/5 transition-colors"
              >
                <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                  ...
                  <span className="truncate text-sm sm:text-base text-fg font-medium">{renderPrimary(item)}</span>
                </div>
